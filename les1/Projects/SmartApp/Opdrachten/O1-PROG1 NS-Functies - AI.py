...
def standaardprijs(afstand_km):
    ...
    Args:
        afstand_km (int): De reisafstand in kilometers.
    ...
    if afstand_km <= 0:
        return 0.0
    return afstand_km * 0.80 if afstand_km <= 50 else 15 + afstand_km * 0.60
...
def ritprijs(leeftijd, weekendrit, afstand_km):
    ...
    if leeftijd < 12 or leeftijd >= 65:
        ...
        korting = 0.40 if weekendrit else 0.0

    return round(prijs * (1 - korting), 2)
